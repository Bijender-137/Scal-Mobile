      ...
      <section className="py-5">
        <Container className="custome_container">
          <Row className="justify-content-between align-items-center flex-column-reverse flex-md-row">
            <Col md={6} lg={5}>
              <p className="position-relative linear_line lh_15 clr_light_gray ms-4 ms-md-0 fs_lg fw-normal max_width_405 mb-0">
            ...
            <Col md={6} lg={6}>
              <div className="mobile_img_w mx-auto mb-4 mb-md-0">
                <img
                  className="w-100"
