          ...
          <div className="mx_1080 line_before mx-auto  position-relative pt-5 mt-4">
            <Row className="justify-content-between align-items-lg-center align-items-start position-relative after_dot ">
              <Col lg={5} sm={2}>
                <div className="text-lg-end">
                  <h1 className="text_border  fs_8xl ps-lg-0 ps-md-5 ps-sm-4 ps-4 ms-md-0 ms-2">
                    01
                  </h1>
                </div>
              </Col>
            ...
            <Row className="after_dot_2 position-relative justify-content-between align-items-lg-center">
              ...
              <Col
                lg={5}
                sm={10}
                className="pt-lg-5 mt-sm-5  position-relative"
              >
                <div className="ps-sm-0 ps-4 ms-sm-0 ms-2">
                  <h1 className=" fs_xl fw-medium text-white mb-0 text-lg-end">
                    It’s All About What Adds Value For You
                  </h1>
                  <p className="text-lg-end  fs_sm fw-normal opacity_07 text-white pt-3">
